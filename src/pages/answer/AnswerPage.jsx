    ...
    <>
      <div>
        <div className="container">
            <div className='py-10'>
                <label className='font-extrabold text-2xl py-5' htmlFor="">Поиск в вопросах и ответах:</label> <br />
                  <input className='border-b w-full p-2 outline-none border-black py-5' type="text" placeholder='Введите свой вопрос...'/>
            </div>

            <div className='pb-10'>

            <div>
                <h1 className='text-4xl font-extrabold py-10'>Виртуальный адрес в Великобритании</h1>
            </div>
            ...
            <div>
                <h1 className='text-4xl font-extrabold py-10'>Покупки в магазинаx Англии, скидки и промкода</h1>
            </div>
            ...
            <div>
                <h1 className='text-4xl font-extrabold py-10'>Доставка из Англии</h1>
            </div>
            ...
            <div>
                <h1 className='text-4xl font-extrabold py-10'>Оплата</h1>
            </div>
            ...
            <div>
                <h1 className='text-4xl font-extrabold py-10'>Общие вопросы</h1>
            </div>
            ...
            <div>
                <h1 className='text-4xl font-extrabold py-10'>Посылки</h1>
            </div>
